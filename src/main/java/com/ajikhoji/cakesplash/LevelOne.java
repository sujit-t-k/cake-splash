...
public class LevelOne {
    ...
    public void buildPane() {
        ...
        lblScore = new Text();
        this.setValue(0L);
       // nlblScore.setStyle("-fx-font-size: 40px;");
        lblScore.setFont(Font.font("Algerian", FontWeight.NORMAL, FontPosture.REGULAR, 40));
        //lblScore.setFont(Font.font("Arial", FontWeight.NORMAL, FontPosture.ITALIC, 16.0D));
        lblScore.setFill(Color.ANTIQUEWHITE);//Color.web("#FFF200")
        lblScore.setLayoutX(60.0D);
        lblScore.setLayoutY(LevelProperties.DBL_GAME_AREA_HEIGHT / 3 + 80.0D);
        ...
        txtMoves.setLayoutY(LevelProperties.DBL_GAME_AREA_HEIGHT / 2 + 40.0D);
        ...
        Text txt_target = new Text("TARGET: 2000");
        ...
        pane_left.getChildren().addAll(rect_exit, txt_exit, t_level, imgViewScoreBoardUI, lblScore, txtMoves, txt_target);
    ...
    private boolean isTargetAchieved() {
        return this.getCurrentValue() >= 2000L;
    }
    ...
    public final void setValue(final long Value, final long milliseconds) {
        ...
        for (double duration_ms = 0; duration_ms < milliseconds; duration_ms += 20) {
            this.t.getKeyFrames().add(new KeyFrame(Duration.millis(duration_ms), new KeyValue(lblScore.textProperty(), String.valueOf((int) (OLD_VALUE + (DIFFERENCE * (duration_ms / milliseconds)))))));
        }
        this.t.getKeyFrames().add(new KeyFrame(Duration.millis(milliseconds), new KeyValue(lblScore.textProperty(), String.valueOf((int) (VALUE)))));
        this.t.play();
    }
    ...
    public class NumericalLabel extends Label {
        ...
        public final void setValue(final long Value, final long milliseconds) {
            setFont(Font.font("Arial", FontWeight.NORMAL, FontPosture.ITALIC, 16.0D));
            if (milliseconds == 0) {
                setValue(Value);
                return;
            } else if (milliseconds < 0) {
    ...
    private void validateMove(final short ID) {
        ...
        if (clear_IDS.size() < 2) {
            ...
            this.setValue(this.getCurrentValue() + increment, 500L);
            tls.playFromStart();
        }
    }
    ...
    private final static void loadResources() {
        ...
        LevelProperties.img[0] = new Image(LevelOne.class.getResource("images/cakes/triangular_cake_pink.png").toString(), LevelProperties.DBL_IMG_WIDTH, LevelProperties.DBL_IMG_HEIGHT, true, true);
        LevelProperties.img[1] = new Image(LevelOne.class.getResource("images/cakes/rectangular_cake_orange.png").toString(), LevelProperties.DBL_IMG_WIDTH, LevelProperties.DBL_IMG_HEIGHT, true, true);
        LevelProperties.img[2] = new Image(LevelOne.class.getResource("images/cakes/triangular_cake_cherry_brown.png").toString(), LevelProperties.DBL_IMG_WIDTH, LevelProperties.DBL_IMG_HEIGHT, true, true);
        LevelProperties.img[3] = new Image(LevelOne.class.getResource("images/cakes/cup_cake_light_blue_brown.png").toString(), LevelProperties.DBL_IMG_WIDTH, LevelProperties.DBL_IMG_HEIGHT, true, true);
        LevelProperties.img[4] = new Image(LevelOne.class.getResource("images/cakes/round_cake_green.png").toString(), LevelProperties.DBL_IMG_WIDTH, LevelProperties.DBL_IMG_HEIGHT, true, true);
        if (Math.random() > 0.5D) {
            imgbg = new Image(LevelOne.class.getResource("images/bg/farm1.png").toString(), LevelProperties.DBL_GAME_AREA_WIDTH - 10.0D, LevelProperties.DBL_GAME_AREA_HEIGHT + 170.0D, true, true);
        } else if (Math.random() > 0.5D) {
            imgbg = new Image(LevelOne.class.getResource("images/bg/castle.png").toString(), LevelProperties.DBL_GAME_AREA_WIDTH - 10.0D, LevelProperties.DBL_GAME_AREA_HEIGHT + 170.0D, true, true);
        } else {
            imgbg = new Image(LevelOne.class.getResource("images/bg/farm2.png").toString(), LevelProperties.DBL_GAME_AREA_WIDTH - 10.0D, LevelProperties.DBL_GAME_AREA_HEIGHT + 170.0D, true, true);
        }
        //if(Math.random() < 0.5D) {
        imgScoreBoard = new Image(LevelOne.class.getResource("images/ui/score_board_1.png").toString(), 250.0D, 130.0D, true, true);
        //}
    }
    ...
    public class SFXPlayer {
        ...
        public SFXPlayer() {
            Media sfx_m1 = new Media(Objects.requireNonNull(GameFrame.class.getResource("audio/soundfx/start.mp3")).toExternalForm());
